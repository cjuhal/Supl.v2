...
function suplemento_general(){
  ...
  function get_list_subcategories($parent){
  	...
  	foreach($categories as $category)
  		$result .= '<option value="'.$category->cat_ID.'">' . $category->cat_name . ' ('.$category->cat_ID. ') </option>';
...
function g1v3m3_suplementos(){
  ...
  foreach ($titulos as $index => $titulo) {
    $content .= "<tr>";
      ...
      $content .= "</td>";
      $content .= "<td>";
        $content .= "<select class='categorias' name='categorias_$index' id='categorias_$index'>";
          $content .= get_list_categories();
        $content .= "</select>";
      $content .= "</td>";
      $content .= "<td>";
        $content .= "<span name='noticias_$index' id='noticias_$index'></span>";
      $content .= "</td>";
    $content .= "</tr>";
  }
